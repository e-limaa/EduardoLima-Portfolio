...
const translations: Record<Language, Record<string, string>> = {
    "en": {
        ...
        "newsletter.page.badge": "AI Newsletter",
        "newsletter.page.title": "Stay ahead of the AI revolution.",
        "newsletter.page.description": "Three times a week I send a strategic curation of the main Artificial Intelligence news, automatically collected via RSS and organized by an automation I built myself with n8n.",
        "newsletter.page.eyebrow": "Automation with judgment. Information without noise.",
        "newsletter.page.nameLabel": "Name",
        "newsletter.page.namePlaceholder": "How would you like to be addressed?",
        "newsletter.page.emailLabel": "Email",
        "newsletter.page.emailPlaceholder": "your.best@email.com",
        "newsletter.page.submitIdle": "Join the list",
        "newsletter.page.submitLoading": "Subscribing...",
        "newsletter.page.submitSuccess": "Successfully subscribed!",
        "newsletter.page.successInline": "You were added to the list. Check your email.",
        "newsletter.page.disclaimer": "No spam. Unsubscribe anytime.",
        "newsletter.page.howItWorksTitle": "How does it work?",
        "newsletter.page.howItWorksDescription": "The newsletter is powered by an automation I created using n8n.",
        "newsletter.page.listTitle": "It:",
        "newsletter.page.resultTitle": "Result:",
        "newsletter.page.resultDescription": "You receive relevant information, consistently and without depending on social networks or algorithms.",
        "newsletter.page.whyTitle": "Why is this different?",
        "newsletter.page.whyDescription": "Most AI content is driven by hype.",
        "newsletter.page.proposalTitle": "My proposal is simple:",
        "newsletter.page.closingLine1": "Automation guarantees consistency.",
        "newsletter.page.closingLine2": "Judgment guarantees quality.",
        "newsletter.page.mobilePreviewAlt": "Newsletter mobile preview",
        "newsletter.page.previewAlt": "Newsletter preview",
        "newsletter.page.footerCopyright": "Design Portfolio",
        "newsletter.page.footerTech": "Developed with React & Tailwind",
        "newsletter.page.toast.successTitle": "Successfully subscribed!",
        "newsletter.page.toast.successDescription": "You were added to our list.",
        "newsletter.page.toast.duplicateTitle": "You are already subscribed!",
        "newsletter.page.toast.duplicateDescription": "This email is already on our list.",
        "newsletter.page.toast.errorTitle": "Subscription error.",
        "newsletter.page.toast.errorDescription": "Please try again later.",
        "newsletter.page.step.1": "Fetches news from reliable sources via RSS",
        "newsletter.page.step.2": "Organizes and structures the content",
        "newsletter.page.step.3": "Filters what actually matters",
        "newsletter.page.step.4": "Creates the HTML email with my visual identity",
        "newsletter.page.step.5": "Sends automatically three times a week",
        "newsletter.page.diff.1": "Reliable sources",
        "newsletter.page.diff.2": "Constant updates",
        "newsletter.page.diff.3": "Less noise",
    ...
    "pt-br": {
        ...
        "newsletter.page.badge": "Newsletter IA",
        "newsletter.page.title": "Fique a frente da revolucao da IA.",
        "newsletter.page.description": "Tres vezes por semana envio uma curadoria estrategica das principais noticias de Inteligencia Artificial, coletadas automaticamente via RSS e organizadas por uma automacao que eu mesmo desenvolvi com n8n.",
        "newsletter.page.eyebrow": "Automacao com criterio. Informacao sem ruido.",
        "newsletter.page.nameLabel": "Nome",
        "newsletter.page.namePlaceholder": "Como gosta de ser chamado(a)?",
        "newsletter.page.emailLabel": "E-mail",
        "newsletter.page.emailPlaceholder": "seu.melhor@email.com",
        "newsletter.page.submitIdle": "Entrar na lista",
        "newsletter.page.submitLoading": "Inscrevendo...",
        "newsletter.page.submitSuccess": "Inscrito com sucesso!",
        "newsletter.page.successInline": "Voce foi adicionado a lista. Verifique seu email.",
        "newsletter.page.disclaimer": "Sem spam. Cancelamento a qualquer momento.",
        "newsletter.page.howItWorksTitle": "Como funciona?",
        "newsletter.page.howItWorksDescription": "A newsletter e alimentada por uma automacao criada por mim utilizando n8n.",
        "newsletter.page.listTitle": "Ela:",
        "newsletter.page.resultTitle": "Resultado:",
        "newsletter.page.resultDescription": "Voce recebe informacao relevante, com consistencia e sem depender de redes sociais ou algoritmo.",
        "newsletter.page.whyTitle": "Por que isso e diferente?",
        "newsletter.page.whyDescription": "A maioria dos conteudos sobre IA vive de hype.",
        "newsletter.page.proposalTitle": "Minha proposta e simples:",
        "newsletter.page.closingLine1": "Automacao garante consistencia.",
        "newsletter.page.closingLine2": "Criterio garante qualidade.",
        "newsletter.page.mobilePreviewAlt": "Preview mobile da newsletter",
        "newsletter.page.previewAlt": "Preview da newsletter",
        "newsletter.page.footerCopyright": "Design Portfolio",
        "newsletter.page.footerTech": "Developed with React & Tailwind",
        "newsletter.page.toast.successTitle": "Inscrito com sucesso!",
        "newsletter.page.toast.successDescription": "Voce foi adicionado a nossa lista.",
        "newsletter.page.toast.duplicateTitle": "Voce ja esta inscrito!",
        "newsletter.page.toast.duplicateDescription": "Este e-mail ja faz parte da nossa lista.",
        "newsletter.page.toast.errorTitle": "Erro ao se inscrever.",
        "newsletter.page.toast.errorDescription": "Tente novamente mais tarde.",
        "newsletter.page.step.1": "Busca noticias em fontes confiaveis via RSS",
        "newsletter.page.step.2": "Organiza e estrutura o conteudo",
        "newsletter.page.step.3": "Filtra o que realmente importa",
        "newsletter.page.step.4": "Cria o e-mail HTML com a minha identidade",
        "newsletter.page.step.5": "Dispara automaticamente tres vezes por semana",
        "newsletter.page.diff.1": "Fontes confiaveis",
        "newsletter.page.diff.2": "Atualizacao constante",
        "newsletter.page.diff.3": "Menos ruido",
