import{r as C,j as e,B as P,F as E,a as M,d as v}from"./index-C9YVZKf2.js";import{u as F,C as z,T as H,P as V,a as B,b as k,c as A}from"./PropTable-CC36o7td.js";import{u as L}from"./useForceRerender-Cuk7ZgGf.js";import{C as I}from"./Customize-thpVeBUB.js";import{P as s}from"./PreviewSlider-CayrcR81.js";import{P as d}from"./PreviewSwitch-UwzRvWsl.js";import{D as O}from"./Dependencies-CuBMykQ5.js";import G from"./LiquidEther-BN9hu7OB.js";import{B as X}from"./BackgroundContent-BiooLacb.js";import{O as Y}from"./OpenInStudioButton-CIszhdIe.js";import"./rotate-ccw-DfybBCbA.js";import"./CodeHighlighter-BRzQV9fE.js";import"./slider-DN1sqGkY.js";import"./switch-DOqE67HY.js";import"./three.module-DbwSNGae.js";const U=`import { useEffect, useRef } from 'react';
...
`,j=`import React, { useEffect, useRef } from 'react';
import * as THREE from 'three';
import './LiquidEther.css';
...
`,q=`import React, { useEffect, useRef } from 'react';
import * as THREE from 'three';
...
`,$={dependencies:"three",usage:`import LiquidEther from './LiquidEther';
...
<div style={{ width: '100%', height: 600, position: 'relative' }}>
  <LiquidEther
    ...
    autoRampDuration={0.6}
  />
</div>`,code:U,css:W,tailwind:N,tsCode:j,tsTailwind:q},_={color0:"#5227FF",color1:"#FF9FFC",color2:"#B19EEF",mouseForce:20,cursorSize:100,resolution:.5,isViscous:!0,viscous:30,iterationsViscous:32,iterationsPoisson:32,isBounce:!1,autoDemo:!0,autoSpeed:.5,autoIntensity:2.2},pe=()=>{const{props:m,updateProp:t,resetProps:S,hasChanges:R}=F(_),{color0:f,color1:g,color2:y,mouseForce:o,cursorSize:r,resolution:a,isViscous:i,viscous:u,iterationsViscous:b,iterationsPoisson:w,isBounce:c,autoDemo:l,autoSpeed:p,autoIntensity:h}=m,x=[f,g,y].filter(Boolean),[T]=L(),D=C.useMemo(()=>[{name:"colors",type:"string[]",default:'["#5227FF", "#FF9FFC", "#B19EEF"]',description:"Array of hex color stops used to build the velocity-to-color palette."},{name:"mouseForce",type:"number",default:"20",description:"Strength multiplier applied to mouse / touch movement when injecting velocity."},{name:"cursorSize",type:"number",default:"100",description:"Radius (in pixels at base resolution) of the force brush."},{name:"resolution",type:"number",default:"0.5",description:"Simulation texture scale relative to canvas size (lower = better performance, more blur)."},{name:"dt",type:"number",default:"0.014",description:"Fixed simulation timestep used inside the advection / diffusion passes."},{name:"BFECC",type:"boolean",default:"true",description:"Enable BFECC advection (error-compensated) for crisper flow; disable for slight performance gain."},{name:"isViscous",type:"boolean",default:"false",description:"Toggle iterative viscosity solve (smoother, thicker motion when enabled)."},{name:"viscous",type:"number",default:"30",description:"Viscosity coefficient used when isViscous is true."},{name:"iterationsViscous",type:"number",default:"32",description:"Number of Gauss-Seidel iterations for viscosity (higher = smoother, slower)."},{name:"iterationsPoisson",type:"number",default:"32",description:"Number of pressure Poisson iterations to enforce incompressibility."},{name:"isBounce",type:"boolean",default:"false",description:"If true, shows bounce boundaries (velocity clamped at edges)."},{name:"autoDemo",type:"boolean",default:"true",description:"Enable idle auto-driving of the pointer when no user interaction."},{name:"autoSpeed",type:"number",default:"0.5",description:"Speed (normalized units/sec) for auto pointer motion."},{name:"autoIntensity",type:"number",default:"2.2",description:"Multiplier applied to velocity delta while in auto mode."},{name:"takeoverDuration",type:"number",default:"0.25",description:"Seconds to interpolate from auto pointer to real cursor when user moves mouse."},{name:"autoResumeDelay",type:"number",default:"1000",description:"Milliseconds of inactivity before auto mode resumes."},{name:"autoRampDuration",type:"number",default:"0.6",description:"Seconds to ramp auto movement speed from 0 to full after activation."},{name:"className",type:"string",default:"''",description:"Optional class for the root container."},{name:"style",type:"React.CSSProperties",default:"{}",description:"Inline styles applied to the root container."}],[]);return e.jsx(z,{props:m,defaultProps:_,resetProps:S,hasChanges:R,children:e.jsxs(H,{children:[e.jsxs(V,{children:[e.jsxs(P,{position:"relative",className:"demo-container",h:600,p:0,overflow:"hidden",children:[e.jsx(G,{colors:x,mouseForce:o,cursorSize:r,resolution:a,isViscous:i,viscous:u,iterationsViscous:b,iterationsPoisson:w,isBounce:c,autoDemo:l,autoSpeed:p,autoIntensity:h,autoResumeDelay:500},T),e.jsx(X,{pillText:"New Background",headline:"The web, made fluid at your fingertips."})]}),e.jsx(E,{justify:"flex-end",mt:2,mb:-2,children:e.jsx(Y,{backgroundId:"liquid-ether",currentProps:{colors:x,mouseForce:o,cursorSize:r,isViscous:i,viscous:u,autoDemo:l,autoSpeed:p,autoIntensity:h,isBounce:c,resolution:a},defaultProps:{mouseForce:20,cursorSize:100,isViscous:!1,viscous:30,colors:["#5227FF","#FF9FFC","#B19EEF"],autoDemo:!0,autoSpeed:.5,autoIntensity:2.2,isBounce:!1,resolution:.5}})}),e.jsxs(I,{className:"preview-options",children:[e.jsxs(E,{alignItems:"center",gap:4,mb:2,wrap:"wrap",children:[e.jsx(M,{fontSize:"sm",mt:2,mb:1,children:"Colors"}),e.jsx(v,{type:"color",value:f,onChange:n=>t("color0",n.target.value),width:"50px",p:0}),e.jsx(v,{type:"color",value:g,onChange:n=>t("color1",n.target.value),width:"50px",p:0}),e.jsx(v,{type:"color",value:y,onChange:n=>t("color2",n.target.value),width:"50px",p:0})]}),e.jsx(s,{title:"Mouse Force",min:0,max:60,step:1,value:o,onChange:n=>t("mouseForce",n)}),e.jsx(s,{title:"Cursor Size",min:10,max:300,step:5,value:r,onChange:n=>t("cursorSize",n)}),e.jsx(s,{title:"Resolution",min:.2,max:.5,step:.05,value:a,onChange:n=>t("resolution",n)}),e.jsx(s,{title:"Auto Speed",min:0,max:1,step:.05,value:p,onChange:n=>t("autoSpeed",n)}),e.jsx(s,{title:"Auto Intensity",min:0,max:4,step:.1,value:h,onChange:n=>t("autoIntensity",n)}),e.jsx(s,{title:"Pressure",min:1,max:64,step:1,value:w,onChange:n=>t("iterationsPoisson",n)}),e.jsx(d,{title:"Bounce Edges",isChecked:c,onChange:n=>t("isBounce",n)}),e.jsx(d,{title:"Auto Animate",isChecked:l,onChange:n=>t("autoDemo",n)}),e.jsx(d,{title:"Viscous",isChecked:i,onChange:n=>t("isViscous",n)}),i&&e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Viscous Coef",min:1,max:100,step:1,value:u,onChange:n=>t("viscous",n)}),e.jsx(s,{title:"Viscous Iterations",min:1,max:64,step:1,value:b,onChange:n=>t("iterationsViscous",n)})]})]}),e.jsx(B,{data:D}),e.jsx(O,{dependencyList:["three"]})]}),e.jsx(k,{children:e.jsx(A,{codeObject:$,componentName:"LiquidEther"})})]})})};export{pe as default};
